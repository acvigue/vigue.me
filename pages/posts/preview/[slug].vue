...
const { data, error } = await useFetch(`/api/cms/preview/${slug}`)
            ...
            <WidthContainer class="flex flex-col items-center gap-4 text-persian">
                ...
                <div class="flex items-center text-xs uppercase tracking-wide font-serif2 font-bold">
                    ...
                    <svg width="24" height="24" fill="none" viewBox="0 0 24 24" class="ml-2 h-4 opacity-75">
                        ...
                        <circle cx="12" cy="12" r="2.25" stroke="currentColor" strokeLinecap="round"
                ...
                <div class="relative">
                    <div
                        class="absolute h-full w-full -rotate-1 transform rounded-md bg-licorice bg-opacity-40 -z-10" />
                    <NuxtPicture format="avif,webp,jpg" :src="data?.feature_image!"
                        sizes="lg:1000px md:750px sm:300px 100px" class="feature-image z-10" :alt="featureImageAlt"
                        :width="2000" :height="1500" placeholder />
                </div>
