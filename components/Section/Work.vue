<template>
  ...
  >
    ...
    <div
      ...
      id="work-horiz-scroll"
    >
      <div
        class="w-[100vw] bg-pink-600 h-full flex items-center justify-center"
        id="work-first-slide"
      >
        <span id="work-first-slide-icon-hat-left" class="opacity-0 rotate-45"
          >🪚</span
        >
        <span id="work-first-slide-words">I do a lot of things...</span>
        <span id="work-first-slide-icon-hat-right" class="opacity-0 -rotate-45"
          >🪛</span
        >
      </div>
      <div
        class="w-[100vw] h-full flex flex-col items-start justify-evenly px-12 pt-24"
        id="work-second-slide"
      >
...
onNuxtReady(() => {
  ...
  ctx = gsap.context(() => {
    const firstSlideWords = new SplitText("#work-first-slide-words", {
      type: "words,lines",
    ...
    const firstSlideTL = gsap.timeline({
      scrollTrigger: {
        trigger: "#work-first-slide",
        start: "top 60%",
        end: "top top-=200",
        scrub: true,
      },
    });
    firstSlideTL.addLabel("start").to("#work-section-title", {
      scrambleText: {
    ...
    firstSlideTL.to(
      "#work-first-slide-icon-hat-left",
      {
    ...
    firstSlideTL.to(
      "#work-first-slide-icon-hat-right",
      {
        css: { opacity: 1, translateY: "-3rem", rotate: 0, scale: 2 },
        duration: 0.01,
      },
    ...
    /*
    thirdSlideTL.to(
      "#work-third-slide-icon-hat-left",
      {
    ...
    thirdSlideTL.to(
      "#work-third-slide-icon-hat-right",
      {
        css: { opacity: 1, translateY: "-3rem", rotate: 45, scale: 2 },
        duration: 0.01,
      },
