export default defineAppConfig({
  ...
  aboutMetaDescription: "Purdue University student actively exploring the realms of Computer Science, Embedded Engineering, and Software & Hardware Development. Innovative leader with experiences in AWS, Oracle Cloud, SwiftFin for Jellyfin and Autodesk's ambassador program. Check out my portfolio and subscribe for updates on my tech odyssey.",
