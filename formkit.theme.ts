...
const classes: Record<string, Record<string, boolean>> = {
  ...
  "family:box__decorator": {
    ...
    "bg-white": true,
    "ring-taupe": true,
    "peer-checked:border-taupe": true,
    relative: true,
    block: true,
    "text-lg": true,
    "w-[1em]": true,
    ...
    "dark:ring-offset-taupe": true,
    "dark:peer-focus-visible:ring-1": true,
    "dark:peer-disabled:bg-neutral-600/50": true,
    "dark:peer-checked:bg-taupe": true,
    "dark:peer-checked:text-taupe": true,
  },
  ...
  "family:text__inner": {
    ...
    "focus-within:!ring-taupe": true,
    "focus-within:!border-taupe": true,
  ...
  "family:dropdown__listitem": {
    ...
    "data-[is-active]:before:ring-taupe": true,
    "data-[is-active]:before:ring-inset": true,
    "data-[is-active]:before:ring-offset-taupe": true,
  },
  ...
  "family:dropdown__loadMoreInner": {
    ...
    "justify-center": true,
    "[&>span]:mr-2": true,
    "hover:text-taupe": true,
    "cursor-pointer": true,
    "dark:text-neutral-200": true,
    "dark:hover:text-taupe": true,
  },
  ...
  "family:dropdown__tagWrapper": {
    ...
    "data-[active-selection=true]:ring-taupe": true,
  },
  ...
  "family:dropdown__tag": {
    ...
    "group-data-[active-selection=true]/tag:bg-taupe": true,
  ...
  date__input: {
    ...
    "selection:text-licorice": true,
    "group-data-[has-overlay]:selection:!text-transparent": true,
    "focus:[&::-webkit-datetime-edit-day-field]:bg-taupe": true,
    "focus:[&::-webkit-datetime-edit-month-field]:bg-taupe": true,
    "focus:[&::-webkit-datetime-edit-year-field]:bg-taupe": true,
  },
  "datetime-local__input": {
    ...
    "focus:[&::-webkit-datetime-edit-month-field]:bg-taupe": true,
    "focus:[&::-webkit-datetime-edit-year-field]:bg-taupe": true,
    "focus:[&::-webkit-datetime-edit-hour-field]:bg-taupe": true,
    "focus:[&::-webkit-datetime-edit-minute-field]:bg-taupe": true,
    "focus:[&::-webkit-datetime-edit-ampm-field]:bg-taupe": true,
  },
  file__fileList: {
    "group/list": true,
    peer: true,
  ...
  file__fileRemove: {
    ...
    "peer-data-[has-multiple]:text-taupe": true,
  ...
  range__input: {
    ...
    "[&::-webkit-slider-thumb]:bg-taupe": true,
    ...
    "[&::-webkit-slider-thumb]:focus:!ring-taupe": true,
    ...
    "[&::-moz-range-thumb]:focus:!ring-taupe": true,
  ...
  select__option: {
    ...
    "group-data-[multiple]:checked:bg-taupe": true,
    "group-data-[multiple]:focus:bg-taupe": true,
    ...
    "dark:group-data-[multiple]:focus:bg-taupe": true,
    "dark:group-data-[multiple]:checked:bg-taupe": true,
  },
  select__prefixIcon: {
    flex: true,
    "items-center": true,
  ...
  submit__input: {
    ...
    "bg-taupe": true,
    "!text-white": true,
    "active:text-taupe": true,
    "active:bg-taupe": true,
    "hover:bg-taupe": true,
  ...
  week__input: {
    ...
    "selection:text-licorice": true,
    "group-data-[has-overlay]:selection:!text-transparent": true,
    "focus:[&::-webkit-datetime-edit-week-field]:bg-taupe": true,
    "focus:[&::-webkit-datetime-edit-year-field]:bg-taupe": true,
  },
  ...
  colorpicker__fieldGroup: {
    ...
    "[&>input:focus]:ring-taupe": true,
    "[&>input:focus]:border-taupe": true,
  ...
  colorpicker__swatch: {
    ...
    "[&>canvas:focus-visible]:ring-taupe": true,
  ...
  datepicker__dayCell: {
    ...
    "dark:bg-neutral-600": true,
    "dark:text-licorice": true,
    "dark:aria-selected:bg-taupe": true,
    "dark:aria-selected:text-white": true,
    "dark:focus:outline-taupe": true,
  ...
  datepicker__timeInput: {
    ...
    "p-1.5": true,
    "my-2.5": true,
    "focus-visible:outline-taupe": true,
    "dark:text-licorice": true,
    "dark:bg-transparent": true,
    "dark:border-khaki": true,
  },
  ...
  toggle__track: {
    ...
    "shadow-sm": true,
    "peer-focus-visible:ring-2": true,
    "peer-focus-visible:ring-taupe": true,
  ...
  togglebuttons__input: {
    ...
    "dark:disabled:text-taupe": true,
    "dark:text-taupe": true,
    "aria-[pressed=true]:bg-taupe": true,
    "aria-[pressed=true]:text-white": true,
    "dark:aria-[pressed=true]:bg-taupe": true,
    ...
    "group-data-[vertical=false]/options:group-[]/option:aria-[pressed=true]:border-x-taupe":
      true,
    "group-data-[vertical=false]/options:group-first/option:aria-[pressed=true]:border-l-taupe":
      true,
    "group-data-[vertical=false]/options:group-last/option:aria-[pressed=true]:border-r-taupe":
      true,
    "dark:group-data-[vertical=false]/options:group-[]/option:aria-[pressed=true]:border-x-taupe":
      true,
    "dark:group-data-[vertical=false]/options:group-first/option:aria-[pressed=true]:border-l-taupe":
      true,
    "dark:group-data-[vertical=false]/options:group-last/option:aria-[pressed=true]:border-r-taupe":
      true,
    ...
    "group-data-[vertical=true]/options:group-[]/option:aria-[pressed=true]:border-y-taupe":
      true,
    "group-data-[vertical=true]/options:group-first/option:aria-[pressed=true]:border-t-taupe":
      true,
    "group-data-[vertical=true]/options:group-last/option:aria-[pressed=true]:border-b-taupe":
      true,
    "dark:group-data-[vertical=true]/options:group-[]/option:aria-[pressed=true]:border-y-taupe":
      true,
    "dark:group-data-[vertical=true]/options:group-first/option:aria-[pressed=true]:border-t-taupe":
      true,
    "dark:group-data-[vertical=true]/options:group-last/option:aria-[pressed=true]:border-b-taupe":
      true,
  },
  transferlist__outer: {
    group: true,
    ...
    "text-base": true,
    "max-w-none": true,
    "[&_.dnd-placeholder]:bg-taupe": true,
  ...
  transferlist__transferlist: {
    ...
    "[&:has(:focus-visible)]:ring-taupe": true,
    "dark:border-khaki": true,
  ...
  transferlist__transferlistListItem: {
    ...
    "aria-selected:bg-taupe": true,
    "data-[is-active=true]:bg-taupe": true,
    "data-[is-active=true]:ring-taupe": true,
    "aria-selected:ring-taupe": true,
    relative: true,
    flex: true,
    "cursor-pointer": true,
    "items-center": true,
    ...
    "dark:bg-neutral-800": true,
    "dark:text-licorice": true,
    "dark:data-[is-active=true]:bg-taupe": true,
    "dark:aria-selected:bg-taupe": true,
    "dark:ring-licorice": true,
    "dark:data-[is-active=true]:ring-taupe": true,
    "dark:aria-selected:ring-taupe": true,
    "[&.formkit-dropZone]:bg-taupe": true,
    "[&.formkit-selectionDropZone]:bg-taupe": true,
    "[&.formkit-touchDropZone]:bg-taupe": true,
    "[&.formkit-touchSelectionDropZone]:bg-taupe": true,
    "[&.formkit-longTouch]:bg-taupe": true,
    "dark:[&.formkit-dropZone]:bg-taupe": true,
    "dark:[&.formkit-selectionDropZone]:bg-taupe": true,
    "dark:[&.formkit-touchDropZone]:bg-taupe": true,
    "dark:[&.formkit-touchSelectionDropZone]:bg-taupe": true,
    "dark:[&.formkit-longTouch]:bg-taupe": true,
  },
  ...
  "multi-step__tab": {
    ...
    'group-data-[tab-style="progress"]/wrapper:data-[valid=true]:data-[visited=true]:after:bg-taupe':
      true,
    ...
    'dark:group-data-[tab-style="progress"]/wrapper:data-[valid=true]:data-[visited=true]:after:bg-taupe':
      true,
  },
  ...
  "multi-step__badge": {
    ...
    "text-white": true,
    "rounded-full": true,
    "group-data-[valid=true]/tab:bg-taupe": true,
