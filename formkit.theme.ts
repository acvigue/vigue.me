...
const classes: Record<string, Record<string, boolean>> = {
  ...
  "family:dropdown__inner": {
    ...
    "dark:bg-transparent": true,
    "dark:border-khaki": true,
    "dark:group-data-[disabled]:bg-licorice/40": true,
    "dark:group-data-[invalid]:border-red-500": true,
    "dark:group-data-[invalid]:ring-red-500": true,
  },
  ...
  "family:dropdown__listbox": {
    ...
    "group-data-[overscroll]:border-khaki": true,
    "group-data-[overscroll]:dark:border-khaki": true,
  },
  "family:dropdown__listitem": {
    ...
    "text-licorice": true,
    "text-base": true,
    "data-[is-active]:bg-persian": true,
    "dark:text-neutral-200": true,
    "dark:data-[is-active]:text-licorice": true,
    "before:content-['']": true,
    ...
    "data-[is-active]:before:ring-persian": true,
    "data-[is-active]:before:ring-inset": true,
    "data-[is-active]:before:ring-offset-persian": true,
  },
  ...
  "family:dropdown__loadMoreInner": {
    ...
    "justify-center": true,
    "[&>span]:mr-2": true,
    "hover:text-persian": true,
    "cursor-pointer": true,
    "dark:text-neutral-200": true,
    "dark:hover:text-persian": true,
  },
  ...
  "family:dropdown__tagWrapper": {
    ...
    "data-[active-selection=true]:ring-persian": true,
  },
  ...
  "family:dropdown__tag": {
    ...
    "group-data-[active-selection=true]/tag:bg-persian": true,
    "group-data-[active-selection=true]/tag:text-licorice": true,
  },
  ...
  color__inner: {
    ...
    "group-data-[prefix-icon]:border-khaki": true,
    "group-data-[suffix-icon]:border": true,
    "group-data-[suffix-icon]:border-khaki": true,
    "dark:group-data-[prefix-icon]:border-khaki": true,
    "dark:group-data-[suffix-icon]:border-khaki": true,
  },
  color__input: {
    "appearance-none": true,
    "[color-scheme:light]": true,
  ...
  date__input: {
    ...
    "selection:text-licorice": true,
    "group-data-[has-overlay]:selection:!text-transparent": true,
    "focus:[&::-webkit-datetime-edit-day-field]:bg-persian": true,
    "focus:[&::-webkit-datetime-edit-month-field]:bg-persian": true,
    "focus:[&::-webkit-datetime-edit-year-field]:bg-persian": true,
  },
  "datetime-local__input": {
    ...
    "focus:[&::-webkit-datetime-edit-month-field]:bg-persian": true,
    "focus:[&::-webkit-datetime-edit-year-field]:bg-persian": true,
    "focus:[&::-webkit-datetime-edit-hour-field]:bg-persian": true,
    "focus:[&::-webkit-datetime-edit-minute-field]:bg-persian": true,
    "focus:[&::-webkit-datetime-edit-ampm-field]:bg-persian": true,
  },
  file__fileList: {
    "group/list": true,
    peer: true,
  ...
  file__fileRemove: {
    ...
    "peer-data-[has-multiple]:text-persian": true,
  ...
  range__input: {
    ...
    "[&::-webkit-slider-thumb]:bg-persian": true,
    ...
    "[&::-webkit-slider-thumb]:group-data-[disabled]:!ring-licorice": true,
    "[&::-webkit-slider-thumb]:focus-visible:ring-2": true,
    "[&::-webkit-slider-thumb]:focus:!ring-persian": true,
    ...
    "dark:[&::-webkit-slider-thumb]:group-data-[disabled]:!ring-neutral-600":
      true,
    "dark:[&::-webkit-slider-thumb]:focus:ring-offset-licorice": true,
    ...
    "dark:[&::-moz-range-thumb]:focus:ring-offset-licorice": true,
  },
  select__wrapper: {
    "mb-1.5": true,
  },
  ...
  select__option: {
    ...
    "group-data-[multiple]:checked:bg-persian": true,
    "group-data-[multiple]:focus:bg-persian": true,
    ...
    "dark:group-data-[multiple]:focus:bg-persian": true,
    "dark:group-data-[multiple]:checked:bg-persian": true,
  },
  select__prefixIcon: {
    flex: true,
    "items-center": true,
  ...
  week__input: {
    ...
    "selection:text-licorice": true,
    "group-data-[has-overlay]:selection:!text-transparent": true,
    "focus:[&::-webkit-datetime-edit-week-field]:bg-persian": true,
    "focus:[&::-webkit-datetime-edit-year-field]:bg-persian": true,
  },
  ...
  autocomplete__selectionWrapper: {
    ...
    "group-data-[multiple]:border-khaki": true,
    "group-data-[multiple]:mb-1.5": true,
    "outline-none": true,
    "data-[active-selection=true]:ring-2": true,
    "data-[active-selection=true]:ring-persian": true,
    "dark:bg-neutral-600": true,
    "dark:group-data-[multiple]:border-khaki": true,
  ...
  colorpicker__valueString: {
    ...
    "mr-1.5": true,
    "dark:text-licorice": true,
    "dark:selection:text-licorice": true,
  },
  colorpicker__panel: {
    absolute: true,
    "left-0": true,
  ...
  colorpicker__control: {
    ...
    "focus-visible:ring-persian": true,
  },
  ...
  colorpicker__fieldGroup: {
    ...
    "[&>input]:p-1": true,
    "[&>input]:text-sm": true,
    "[&>input]:text-licorice": true,
    "[&>input]:selection:bg-persian": true,
    "[&>input]:m-0": true,
    "[&>input]:grow": true,
    "[&>input]:shrink": true,
    "[&>input]:w-full": true,
    "[&>input]:border": true,
    "[&>input]:border-khaki": true,
    "[&>input]:rounded": true,
    ...
    "[&>input:focus]:ring-persian": true,
    "[&>input:focus]:border-persian": true,
  ...
  colorpicker__swatch: {
    ...
    "[&>canvas:focus-visible]:ring-persian": true,
    "[&>canvas:focus-visible]:ring-offset-2": true,
    "[&>canvas:focus-visible]:ring-offset-white": true,
    "dark:[&>canvas:focus-visible]:ring-offset-licorice": true,
  },
  datepicker__inner: {
    relative: true,
    "pl-0": true,
  ...
  datepicker__month: {
    ...
    "focus:outline-persian": true,
    "focus:outline-offset-2": true,
    "focus:bg-white": true,
    "focus:text-licorice": true,
  ...
  datepicker__dayCell: {
    ...
    "dark:bg-neutral-600": true,
    "dark:text-licorice": true,
    "dark:aria-selected:bg-persian": true,
    "dark:aria-selected:text-white": true,
    "dark:focus:outline-persian": true,
    "dark:focus:bg-neutral-200": true,
    "dark:focus:text-licorice": true,
  },
  datepicker__timeInput: {
    ...
    "p-1.5": true,
    "my-2.5": true,
    "focus-visible:outline-persian": true,
    "dark:text-licorice": true,
    "dark:bg-transparent": true,
    "dark:border-khaki": true,
  },
  ...
  datepicker__dayButton: {
    ...
    "dark:text-licorice": true,
    "dark:border-khaki": true,
    "dark:hover:border-persian": true,
  },
  ...
  datepicker__calendarIcon: {
    "text-neutral-600": true,
    "focus-visible:text-persian": true,
    flex: true,
    "w-[1em]": true,
    "grow-0": true,
    "shrink-0": true,
  ...
  mask__input: {
    ...
    "selection:text-licorice": true,
    "group-data-[has-overlay]:selection:!text-transparent": true,
    "group-data-[has-overlay]:!caret-licorice": true,
    "dark:group-data-[has-overlay]:!caret-licorice": true,
  },
  rating__inner: {
    flex: true,
    "w-[130px]": true,
  ...
  repeater__downControl: {
    ...
    "dark:text-licorice": true,
    "dark:disabled:!text-licorice": true,
    "dark:hover:text-persian": true,
  },
  repeater__upControl: {
    "w-[1.5em]": true,
  ...
  slider__chartBar: {
    ...
    "h-full": true,
    "bg-neutral-400": true,
    "data-[active=false]:bg-licorice": true,
    "dark:bg-neutral-500": true,
  ...
  toggle__track: {
    ...
    "shadow-sm": true,
    "peer-focus-visible:ring-2": true,
    "peer-focus-visible:ring-persian": true,
  ...
  togglebuttons__input: {
    ...
    "dark:disabled:text-persian": true,
    "dark:text-persian": true,
    "aria-[pressed=true]:bg-persian": true,
    "aria-[pressed=true]:text-white": true,
    "dark:aria-[pressed=true]:bg-persian": true,
    ...
    "group-data-[vertical=false]/options:group-[]/option:aria-[pressed=true]:border-x-persian":
      true,
    "group-data-[vertical=false]/options:group-first/option:aria-[pressed=true]:border-l-persian":
      true,
    "group-data-[vertical=false]/options:group-last/option:aria-[pressed=true]:border-r-persian":
      true,
    "dark:group-data-[vertical=false]/options:group-[]/option:aria-[pressed=true]:border-x-persian":
      true,
    "dark:group-data-[vertical=false]/options:group-first/option:aria-[pressed=true]:border-l-persian":
      true,
    "dark:group-data-[vertical=false]/options:group-last/option:aria-[pressed=true]:border-r-persian":
      true,
    ...
    "group-data-[vertical=true]/options:group-[]/option:aria-[pressed=true]:border-y-persian":
      true,
    "group-data-[vertical=true]/options:group-first/option:aria-[pressed=true]:border-t-persian":
      true,
    "group-data-[vertical=true]/options:group-last/option:aria-[pressed=true]:border-b-persian":
      true,
    "dark:group-data-[vertical=true]/options:group-[]/option:aria-[pressed=true]:border-y-persian":
      true,
    "dark:group-data-[vertical=true]/options:group-first/option:aria-[pressed=true]:border-t-persian":
      true,
    "dark:group-data-[vertical=true]/options:group-last/option:aria-[pressed=true]:border-b-persian":
      true,
  },
  transferlist__outer: {
    group: true,
    ...
    "text-base": true,
    "max-w-none": true,
    "[&_.dnd-placeholder]:bg-persian": true,
  ...
  transferlist__transferlist: {
    ...
    "[&:has(:focus-visible)]:ring-persian": true,
    "dark:border-khaki": true,
  ...
  transferlist__transferlistListItem: {
    ...
    "aria-selected:bg-persian": true,
    "data-[is-active=true]:bg-persian": true,
    "data-[is-active=true]:ring-persian": true,
    "aria-selected:ring-persian": true,
    relative: true,
    flex: true,
    "cursor-pointer": true,
    "items-center": true,
    ...
    "dark:bg-neutral-800": true,
    "dark:text-licorice": true,
    "dark:data-[is-active=true]:bg-persian": true,
    "dark:aria-selected:bg-persian": true,
    "dark:ring-licorice": true,
    "dark:data-[is-active=true]:ring-persian": true,
    "dark:aria-selected:ring-persian": true,
    "[&.formkit-dropZone]:bg-persian": true,
    "[&.formkit-selectionDropZone]:bg-persian": true,
    "[&.formkit-touchDropZone]:bg-persian": true,
    "[&.formkit-touchSelectionDropZone]:bg-persian": true,
    "[&.formkit-longTouch]:bg-persian": true,
    "dark:[&.formkit-dropZone]:bg-persian": true,
    "dark:[&.formkit-selectionDropZone]:bg-persian": true,
    "dark:[&.formkit-touchDropZone]:bg-persian": true,
    "dark:[&.formkit-touchSelectionDropZone]:bg-persian": true,
    "dark:[&.formkit-longTouch]:bg-persian": true,
  },
  ...
  transferlist__transferlistSearch: {
    ...
    "dark:border-khaki": true,
    "dark:text-licorice": true,
    "dark:selection:bg-persian": true,
    "dark:selection:text-licorice": true,
    "dark:bg-neutral-800": true,
  },
  ...
  "multi-step__tabs": {
    ...
    'group-data-[tab-style="tab"]/wrapper:border-khaki': true,
    ...
    'dark:group-data-[tab-style="tab"]/wrapper:border-khaki': true,
  ...
  "multi-step__tab": {
    ...
    'group-data-[tab-style="tab"]/wrapper:text-licorice': true,
    ...
    'group-data-[tab-style="tab"]/wrapper:data-[active=true]:shadow-[0_0_0.5em_0_rgba(0,0,0,0.1)]':
      true,
    'dark:group-data-[tab-style="tab"]/wrapper:text-licorice': true,
    ...
    'group-data-[tab-style="progress"]/wrapper:before:border-khaki': true,
    ...
    'dark:group-data-[tab-style="progress"]/wrapper:before:border-khaki': true,
    ...
    'group-data-[tab-style="progress"]/wrapper:after:left-[calc(50%+0.5em)]':
      true,
    'group-data-[tab-style="progress"]/wrapper:after:bg-licorice': true,
    'group-data-[tab-style="progress"]/wrapper:data-[valid=true]:data-[visited=true]:after:bg-persian':
      true,
    ...
    'dark:group-data-[tab-style="progress"]/wrapper:data-[valid=true]:data-[visited=true]:after:bg-persian':
      true,
  },
  "multi-step__tabLabel": {
    ...
    'dark:group-data-[tab-style="progress"]/wrapper:text-licorice': true,
  },
  "multi-step__badge": {
    "bg-red-600": true,
    absolute: true,
    ...
    "text-white": true,
    "rounded-full": true,
    "group-data-[valid=true]/tab:bg-persian": true,
